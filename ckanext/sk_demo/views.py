...
@bp.route("/sk_demo/page")
def page():
    """Basic page."""
    return "Hello, sk_demo!"


@bp.route("/sk_demo/page-redirect")
def page_redirect():
    """Complex page."""
    return tk.redirect_to("sk_demo.page")
...
class ComplexView(MethodView):
    ...
    def post(self, word: str):
        ...
        try:
            result = tk.get_action("sk_demo_get_sum")(
                {},
                params,
            )
