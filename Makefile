...
remote-ingest = https://github.com/DataShades/ckanext-ingest.git tag v1.4.4
...
vendor-dir = ckanext/sk_demo/assets/vendor
...
vendor:  ## Copy vendor libraries from node_modules/ to assets directory
	...
	cp node_modules/slick-carousel/slick/ajax-loader.gif ckanext/sk_demo/public
	cp node_modules/slick-carousel/slick/fonts ckanext/sk_demo/public/slick-fonts -r
	cp node_modules/daterangepicker/daterangepicker.{js,css} ckanext/sk_demo/assets/vendor
	cp node_modules/daterangepicker/moment.min.js ckanext/sk_demo/assets/vendor
	cp node_modules/overlayscrollbars/styles/overlayscrollbars.css ckanext/sk_demo/assets/vendor
	cp node_modules/overlayscrollbars/browser/overlayscrollbars.browser.es6.js ckanext/sk_demo/assets/vendor/overlayscrollbars.js
